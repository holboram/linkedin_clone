...
const Footer = () => {
  return (
    <footer className={styles['wrapper-left__footer']} id="footer">
      <ul className={styles['wrapper-left__links-container']}>
        <li>
      ...
      <div className={styles['wrapper-left__trade-mark']}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 14" data-supported-dps="56x14" fill="currentColor" width="56" height="14" focusable="false">
          <g>
